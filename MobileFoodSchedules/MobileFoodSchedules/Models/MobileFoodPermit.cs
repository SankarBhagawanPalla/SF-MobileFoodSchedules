namespace Permits
{
    ...
    public partial class MobileFoodPermit
    {
        public static MobileFoodPermit[] FromJson(string json) => JsonConvert.DeserializeObject<MobileFoodPermit[]>(json, Permits.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MobileFoodPermit[] self) => JsonConvert.SerializeObject(self, Permits.Converter.Settings);
    }
