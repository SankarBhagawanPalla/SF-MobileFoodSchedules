...
namespace QuickTypee
{
    ...
    public partial class MobileFoodSchedule
    {
        ...
        public End24 Start24 { get; set; }

        [JsonProperty("end24")]
        public End24 End24 { get; set; }
        ...
        public DateTimeOffset AddrDateCreate { get; set; }

        [JsonProperty("addr_date_modified", NullValueHandling = NullValueHandling.Ignore)]
        public DateTimeOffset? AddrDateModified { get; set; }
        ...
        public Coldtruck Coldtruck { get; set; }
    ...
    public partial class MobileFoodSchedule
    {
        public static MobileFoodSchedule[] FromJson(string json) => JsonConvert.DeserializeObject<MobileFoodSchedule[]>(json, QuickTypee.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MobileFoodSchedule[] self) => JsonConvert.SerializeObject(self, QuickTypee.Converter.Settings);
    }
