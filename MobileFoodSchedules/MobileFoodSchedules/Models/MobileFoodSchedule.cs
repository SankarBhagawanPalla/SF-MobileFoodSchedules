namespace FoodSchedules
{
    ...
    public partial class MobileFoodSchedule
    {
        public static MobileFoodSchedule[] FromJson(string json) => JsonConvert.DeserializeObject<MobileFoodSchedule[]>(json, FoodSchedules.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MobileFoodSchedule[] self) => JsonConvert.SerializeObject(self, FoodSchedules.Converter.Settings);
    }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                case Time.The10Am:
                    ...
                    return;
                case Time.The10Pm:
                    serializer.Serialize(writer, "10:00 PM");
                    return;
                case Time.The11Am:
                    serializer.Serialize(writer, "11:00 AM");
                    return;
                case Time.The11Pm:
                    serializer.Serialize(writer, "11:00 PM");
                    return;
                case Time.The12Am:
                    serializer.Serialize(writer, "12:00 AM");
                    return;
                case Time.The12Pm:
                    serializer.Serialize(writer, "12:00 PM");
                    return;
                case Time.The1Am:
                    serializer.Serialize(writer, "1:00 AM");
                    return;
                case Time.The1Pm:
                    serializer.Serialize(writer, "1:00 PM");
                    return;
                case Time.The2Pm:
                    serializer.Serialize(writer, "2:00 PM");
                    return;
                case Time.The3Am:
                    serializer.Serialize(writer, "3:00 AM");
                    return;
                case Time.The3Pm:
                    serializer.Serialize(writer, "3:00 PM");
                    return;
                case Time.The4Am:
                    serializer.Serialize(writer, "4:00 AM");
                    return;
                case Time.The4Pm:
                    serializer.Serialize(writer, "4:00 PM");
                    return;
                case Time.The5Am:
                    serializer.Serialize(writer, "5:00 AM");
                    return;
                case Time.The5Pm:
                    serializer.Serialize(writer, "5:00 PM");
                    return;
                case Time.The6Am:
                    serializer.Serialize(writer, "6:00 AM");
                    return;
                case Time.The6Pm:
                    serializer.Serialize(writer, "6:00 PM");
                    return;
                case Time.The7Am:
                    serializer.Serialize(writer, "7:00 AM");
                    return;
                case Time.The7Pm:
                    serializer.Serialize(writer, "7:00 PM");
                    return;
                case Time.The8Am:
                    serializer.Serialize(writer, "8:00 AM");
                    return;
                case Time.The8Pm:
                    serializer.Serialize(writer, "8:00 PM");
                    return;
                case Time.The9Am:
                    serializer.Serialize(writer, "9:00 AM");
                    return;
                case Time.The9Pm:
                    serializer.Serialize(writer, "9:00 PM");
                    return;
            }
